        ...
        <ModalContainer>
          <ModalBtn onClick={handleModal}>
            {isOpen === false ? (
              ...
              <img src="img/talk2.png" alt="당근채팅2" className="talk_logo" />
            )}
          </ModalBtn>
            ...
            <ModalBackdrop>
              <ModalView>
                ...
                <Talk_about>
                  <h1>채팅</h1>
                  <Talk_search_box>
                    <a className="talk-search-btn" href="#"></a>
                    <input
                      type="text"
                      className="talk-search-txt"
                      name=""
                      placeholder="Search"
                    />
                  </Talk_search_box>
                  <ul>
                    <Link to="1">
                      <li>
                        <img
                          src="img/talkuser.png"
                          alt="talk_user"
                          className="talk_user"
                        />
                        <div className="talk_room">
                          <h2>당근이</h2>
                          <p>우리 동네 '신촌'을 인증하고 근처...</p>
                        </div>
                        <img
                          src="img/talkbellIcon.png"
                          alt="talkbell"
                          className="talk_bell"
                        />
                      </li>
