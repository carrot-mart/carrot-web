  ...
  return (
    <Wrapper>
        ...
        <ul>
          <li>
            <a href="" onClick={movePage}>
              <img src="icon/difital_devices.jpeg" />
              <br />
              <p>디지털기기</p>
            </a>
          </li>
          <li>
            <a href="">
              <img src="icon/popular_items.jpeg" />
              <br />
              <p>인기매물</p>
            </a>
          </li>
          ...
          <li>
            <a href="">
              <img src="icon/childrenbook.jpeg" />
              <br />
              <p>유아도서</p>
            </a>
          </li>
          ...
          <li>
            <a href="">
              <img src="icon/women_merchandise.jpeg" />
              <br />
              <p>여성잡화</p>
            </a>
          </li>
          <li>
            <a href="">
              <img src="icon/women's_clothing.jpeg" />
              <br />
              <p>여성의류</p>
            </a>
          </li>
          <li>
            <a href="">
              <img src="icon/men's_fachion.jpeg" />
              <br />
              <p>남성패션/잡화</p>
            </a>
          </li>
          ...
          {PopularItemData.강아지.map((item) => (
            <li>
              <div>
                <img src={item.img} />
                <br />
                <p id="sentence">{item.content}</p>
                <br />
                <span id="area">{item.region}</span>
                <br />
                <span id="price">{item.cost}</span>
              </div>
            </li>
          ))}
        </ul>
      ...
      <PopularSearch>
        ...
        <GridWrapper>
          <ProductGrid productData={keywords.animals.all} />
        </GridWrapper>
      </PopularSearch>
    </Wrapper>
  );
